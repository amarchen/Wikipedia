...
# Generated by qmake (3.0) (Qt 5.1.0) on: Sat Sep 28 18:02:07 2013
...
install_qml: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/projects/Wikipedia/main.qml $(INSTALL_ROOT)/usr/share/Wikipedia/
	-$(INSTALL_PROGRAM) /home/mersdk/projects/Wikipedia/Wikipedia.png $(INSTALL_ROOT)/usr/share/Wikipedia/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/Wikipedia/Wikipedia.png
...
install_appicon: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps || mkdir -p $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps
	-$(INSTALL_PROGRAM) /home/mersdk/projects/Wikipedia/Wikipedia.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/

uninstall_appicon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/Wikipedia.png
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/ 


install:  install_target install_qml install_desktop install_appicon  FORCE

uninstall: uninstall_target uninstall_qml uninstall_desktop uninstall_appicon   FORCE
